...
interface SensorPublisherServiceBindHelper {
    fun bindToSensorPublisherService()
    fun unBindFromSensorPublisherService()
    fun onSensorPublisherServiceConnected(callBack: (SensorPublisherService) -> Unit)
}